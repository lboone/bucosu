...
<?php
class Project_statuses extends Authorized_Controller {
	// -------- HOLDS THE MODEL ------------- //
	...
	$this->_title			= $this->_p.' '.$this->_t.'es';
	$this->_single			= $this->_q.'_'.$this->_n;
	$this->_plural			= $this->_q.'_'.$this->_n.'es';
	$this->_model			= 'mdl_'.$this->_q.'_'.$this->_n.'es';
	$this->_table			= $this->_q.'_'.$this->_n.'es_table';
