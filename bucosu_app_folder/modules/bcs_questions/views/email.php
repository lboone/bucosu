...
<!-- Begin unique part question -->
	...
	<label for="<?php echo $q->slug; ?>" class="field prepend-icon">
		<input type="email" name="<?php echo $q->slug; ?>" id="<?php echo $q->slug; ?>" class="gui-input" value="<?php if(isset($q->answer)){echo $q->answer; }?>" <?php if (isset($disabled)) { echo $disabled; } ?>>
