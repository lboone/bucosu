<div id="new_project_tab_container" class="admin-form <?php echo $tab_content_hidden['new_project'];?>" >
        ...
        <div class="panel-body bg-light">
            ...
            <div id="bcs_info_container">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="project_filter_existing_project" class="field-label">Filter by Existing Project:</label>
                  <div class="section">
                    <label class="field select">
                      <select id="project_filter_existing_project" name="project_filter_existing_project">
                        <option value="none" selected>None</option>
                        <option value="five_years_or_less">Exclude profiles with existing projects</option>
                      </select>
                      <i class="arrow"></i>
                    </label>
                  </div>
              ...
              <div class="row">
                <div class="col-xs-6 col-sm-7 col-md-8 col-lg-9 col-xl-10">
                  <div id="search_for_school_profiles_results_count" class="center-block text-right mt10"></div>
                </div>
  ...
  <!-- BEGIN: The project form -->
  <div id="project_form_container" class="mb30">
    <?php if(isset($new_project_form)){echo $new_project_form;} ?>
  </div>                                <!-- END: #project_form_container -->
