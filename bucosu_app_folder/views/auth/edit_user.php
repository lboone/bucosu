<div class="admin-form theme-info tab-pane center-block mw700" id="edit_user">
  <div class="panel panel-info heading-border">
    <div class="panel-heading">
      <span class="panel-title">
        <i class="fa fa-pencil-square"></i><?php echo lang('edit_user_heading');?>
      </span>
      <?php echo lang('edit_user_subheading');?>
    </div>
    <!-- end .form-header section -->
    <div id="infoMessage"><?php echo $message;?></div>
    <?php echo form_open(uri_string(),array('id'=>'form-register1'));?>
      ...
      <div class= "section row">    
       <?php if ($this->ion_auth->is_admin()): ?>
            <div class="col-md-6" >
              <label for="assoc_companies[]" class="col-md-6 control-label mb5 mln pln"><?php echo lang('edit_user_company_label', 'company');?></label>
        ...
        <?php if ($this->ion_auth->is_admin() && (intval($this->session->userdata('user_id')) !== intval($user->id) ) ) : ?>
            <div class="col-md-6">
              <label for="groups[]" class="col-md-6 control-label mb5 mln pln"><?php echo lang('edit_user_groups_heading');?></label>
              <label class="field select">
        ...
        <div class="section">
          <label for="phone" class="field-label"><?php echo lang('edit_user_phone_label', 'phone');?></label>
        ...
        <div class="section">
          <label for="password" class="field-label"><?php echo lang('edit_user_password_label', 'password');?> </label>
        ...
        <div class="section">
          <label for="password_confirm" class="field-label"><?php echo lang('edit_user_password_confirm_label', 'password_confirm');?></label>
      ...
      <div class="panel-footer">
        ...
        <?php echo form_submit(array('name'=>'submit', 'class'=>'button btn-primary'), lang('edit_user_submit_btn'));?>
      </div>
