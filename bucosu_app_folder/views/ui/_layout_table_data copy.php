  ...
  <div class="panel panel-visible" id="spy2">
    ...
    <div class="panel-body pn">
      <div class="table-responsive">
        <table id="<?php echo $table_settings['table_id']; ?>" class="table table-striped table-hover dataTable" cellpadding=0 cellspacing=10 width="100%" role="grid">
          <thead>
        	<tr role="row">
                    ...
                    $src = $table_row_data_fields[$thd]['src'];
                  	$ext = pathinfo($row->$val,PATHINFO_EXTENSION);             
                        ...
                        case 'doc':
          							case 'xls':
                          echo '<td>';
                          echo '<a href="' . $src . $row->$val . '?lastmod=' . $row->modified .'" data-lightbox="'. $row->$val .'" data-title="' . $src . $row->$val .'" class="thumbnail" style="width:110px; height:110px;" ><img src="' . $src . $row->$val .'?lastmod=' . $row->modified . '" img-thumbnail img-responsive" style="height:100px; width:100px;"></a>';
