...
$config['tables']['groups']          = 'v_groups';
$config['tables']['users_groups']    = 'users_groups';
$config['tables']['login_attempts']  = 'login_attempts';
$config['tables']['group_types']  	 = 'v_group_types';
$config['tables']['companies']  	 = 'v_companies';
 ...
 */
$config['site_title']                 = "bucosu.com";        // Site Title, example.com
$config['admin_email']                = "admin@bucosu.com";  // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<div class="alert alert-macro alert-success alert-border-left alert-dismissable mt5"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check pr10"></i>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-micro alert-border-left alert-danger mt10"><i class="fa fa-info pr10"></i>';		// Error message start delimiter
